...
/* set allocator */
	...
	std::vector<std::string, std::allocator<std::string> > set_allocator;

/* fill constructor */
	ft::vector<int> fill_constructor(42, 'a');
	std::vector<int> fill_constructor(42, 'a');

/* range constructor */
	ft::vector<int> range_constructor(fill_constructor.begin(), fill_constructor.end() - 21);
	std::vector<int> range_constructor(fill_constructor.begin(), fill_constructor.end() - 21);
...
/* assigantion operator */
	...
	std::vector<int> assignation = copy_constructor;
